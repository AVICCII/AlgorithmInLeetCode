...
public class CircleArrayQueueDemo {
    public static void main(String[] args) {
        //测试
        //创建一个队列
        CircleArray arrayQueue = new CircleArray(4);//设置4，则最大为3
        char key = ' ';//接受用户输入
    ...
    //使用数组模拟队列，编写一个ArrayQeue类
     class CircleArray {
        private int maxSize;//表示数组的最大容量
        //front变量的含义做一个调整，front就指向队列的第一个元素，也就是说arr[front]
        //front的初始值为0
        private int front;
        //rear变量的含义做一个调整，rear指向队列的最后一个元素的后一个位置，因为希望作为约定
        //rear的初始值为0
        private int rear;
